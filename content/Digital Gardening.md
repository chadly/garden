...
🍃 I use `+` folder as an inbox for fleeting ideas that get tagged `#seed`. These ideas [[Fleeting Ideas Shouldn't Hang Around|come and go quick]] so it's important to have a quick way to capture the idea. I use a voice recorder when not in front of a PC.
